...
export default function Home() {
  ...
  const prevSlide = () => {
    ...
    const prevIndex = isPrev ? sldes.length - 1 : current - 1;
    setCurrent(prevIndex);
  };

  const nextSlide = () => {
    const isNext = current === sldes.length - 1;
    const nextIndex = isNext ? 0 : current + 1;
  ...
  return (
    <div>
      <div className="pt-5 lg:w-full lg:p-0 p-6">
        ...
        <div className="max-w-280 mx-auto" id="courses">
          <p className="py-5 text-sky-500 font-bold text-2xl">
            หลักสูตร ประกาศนียบัตรวิชาชีพ
          </p>
          <div data-aos="zoom-in-left" className="grid grid-cols-2 md:grid-cols-3 gap-5">
        ...
        <div data-aos="zoom-in" className="lg:w-230 mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-5">
            <div className="border leading-8 rounded-xl p-5 border-sky-500">
              ...
              <p className="pl-1">- การศึกษานอกโรงเรียน ระดับ มัธยมศึกษาตอนต้น ( กศน.ม.3 )</p>
            </div>
            <div className="border leading-9 rounded-xl p-5 border-sky-500">
              ...
              <p className="pl-1">- ประกาศนียบัตรวิชาชีพ ( ปวช. ) ทุกสาขา</p>
              <p className="pl-1">- การศึกษานอกโรงเรียนระดับมัธยมศึกษาตอนปลาย(กศน. ม.6)</p>
            </div>
          </div>
        </div>
        ...
        <div id="activities">
          <div className="lg:w-280 mx-auto">
            <p className="py-5 text-sky-500 text-2xl font-black underline">ภาพรวมกิจกรรม</p>
